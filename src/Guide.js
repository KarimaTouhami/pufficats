                    ...
                    <div className="inner">
                        <div>
                            <ul id="buttons02" className="buttons">
                                <li>
                                    <a href="#" className="button n01">Ellie, 20. She/Her. INTJ-A. CS student. GMT+01.</a>
                                </li>
                            </ul>
                            <p id="text07" className="style1">
                                <span className="p">
                                    ...
                                    <span style={{color: "#E4F2F6"}}>fishs, cats, the ocean, sunset/rise, space, stars, A.I, coding, Genshin,</span>
                                    <strong>doing ma hobbies</strong>
                                    ...
                                    <span style={{color: "#E4F2F6"}}>(honestly, I really get attracted so easily to religious people //3)</span>
                                    <em>italics.</em>
                                    <strong>bold.</strong>
                                    <code>code.</code>
                                    <mark>highlight.</mark>
